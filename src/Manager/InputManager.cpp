...
void InputManager::SetWindow(sf::RenderWindow &a_Window)
{
    m_Window = &a_Window;
}

void InputManager::MoveView(int x, int y)
{
    sf::View t_view = m_Window->getView();
    t_view.move(x, y);
    m_Window->setView(t_view);
}

void InputManager::CenterView(int x, int y)
{
    sf::View t_view = m_Window->getView();
    t_view.setCenter(x, y);
    m_Window->setView(t_view);
}
